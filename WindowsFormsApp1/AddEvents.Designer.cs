namespace WindowsFormsApp1
{
    partial class AddEvents
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.база_данныхDataSet4 = new WindowsFormsApp1.База_данныхDataSet4();
            this.списокмероприятийBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.список_мероприятийTableAdapter = new WindowsFormsApp1.База_данныхDataSet4TableAdapters.Список_мероприятийTableAdapter();
            this.кодмероприятияDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
            ((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.база_данныхDataSet4)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.списокмероприятийBindingSource)).BeginInit();
            this.SuspendLayout();
            // 
            // button3
            // 
            this.button3.Location = new System.Drawing.Point(400, 141);
            ...
            // база_данныхDataSet4
            // 
            this.база_данныхDataSet4.DataSetName = "База_данныхDataSet4";
            this.база_данныхDataSet4.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // списокмероприятийBindingSource
            // 
            this.списокмероприятийBindingSource.DataMember = "Список_мероприятий";
            this.списокмероприятийBindingSource.DataSource = this.база_данныхDataSet4;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.база_данныхDataSet4)).EndInit();
        ...
        private База_данныхDataSet4 база_данныхDataSet4;
        private System.Windows.Forms.BindingSource списокмероприятийBindingSource;
        private База_данныхDataSet4TableAdapters.Список_мероприятийTableAdapter список_мероприятийTableAdapter;
